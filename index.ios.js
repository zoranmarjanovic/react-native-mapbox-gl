...
export function setCameraAnimated(mapRef, latitude, longitude, fromDistance, pitch, heading, duration) {
...
export function setUserTrackingMode(mapRef, userTrackingMode) {
  NativeModules.MapboxGLManager.setUserTrackingMode(React.findNodeHandle(this.refs[mapRef]), userTrackingMode);
}
export function getCenterCoordinateZoomLevel(mapRef, callback) {
  NativeModules.MapboxGLManager.getCenterCoordinateZoomLevel(React.findNodeHandle(this.refs[mapRef]), callback);
}
export function getDirection(mapRef, callback) {
  NativeModules.MapboxGLManager.getDirection(React.findNodeHandle(this.refs[mapRef]), callback);
}

export const mapStyles = NativeModules.MapboxGLManager.mapStyles;
export const userTrackingMode = NativeModules.MapboxGLManager.userTrackingMode;
export const userLocationVerticalAlignment = NativeModules.MapboxGLManager.userLocationVerticalAlignment;
export const unknownResourceCount = NativeModules.MapboxGLManager.unknownResourceCount;
